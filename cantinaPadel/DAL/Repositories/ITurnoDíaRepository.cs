...
namespace cantinaPadel.DAL.Repositories
{
    public interface ITurnoDíaRepository
    {
        ...
        // Todos los turnos del cliente (cualquier fecha/cancha). Por default solo los activos
        // con incluirCancelados=true trae también los cancelados, para poder ver el historial completo del cliente
