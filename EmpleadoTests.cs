...
namespace cantinaPadel.Tests
{
    ...
    {
        // Arma un Empleado con datos válidos para no repetir el mismo bloque en cada test; cada test pisa solo el campo que le interesa
        ...
        {
            // Caso "feliz": usuario, contraseña, rol y datos de persona (incluido el dni obligatorio) pasan juntos la validación.
            var empleado = CrearEmpleadoValido();
