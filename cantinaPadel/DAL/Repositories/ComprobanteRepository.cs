...
namespace cantinaPadel.DAL.Repositories
{
    ...
    {
        // Max()+1 sobre la tabla asume que las ventas se confirman de a una (un solo punto de venta / caja activa)
        // Si en algún momento se necesita más de una caja emitiendo en simultáneo, esto hay que pasarlo a un contador con lock/transacción para
