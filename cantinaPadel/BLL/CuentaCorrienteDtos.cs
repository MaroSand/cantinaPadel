...
// Una unidad de producto pendiente de pago para un cliente (una fila de detalles_venta con Pagado = false)
// El Monto ya refleja el precio actual del producto porque ProductoRepository lo actualiza cuando cambia el precio de venta mientras la unidad sigue pendiente
...
public class ResumenCuentaCorriente
{
    ...
    // Dinero entregado que todavía no saldó por completo la próxima unidad
...
public class ResultadoPagoCuentaCorriente
{
    ...
    // Lo entregado que no alcanzó a saldar por completo la próxima unidad. Queda acreditado y se descuenta de esa unidad
    // no es saldo a favor
